...
#define OPERATOR_DATA_NAME	"currentOperator"
#define MCC_DATA_NAME		"mobileCountryCode"
#define MNC_DATA_NAME		"mobileNetworkCode"
...
#define TEMPERATURE_DATA_NAME	"internalTemperature"
#define MODEM_FW_DATA_NAME	"modemFirmware"
#define ICCID_DATA_NAME		"iccidNumber"
