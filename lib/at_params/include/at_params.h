 ...
 */
int at_params_list_init(struct at_param_list *const list,
 ...
 * @return Zero on success or (negative) error code otherwise.
 */
int at_params_put_string(const struct at_param_list *const list,
			      size_t index, const char *const str,
			      size_t str_len);
 ...
 * @return Zero on success or (negative) error code otherwise.
 */
int at_params_get_string(const struct at_param_list *const list,
			      size_t index, char *const value, size_t len);
